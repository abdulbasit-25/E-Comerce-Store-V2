      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-r from-primary/10 via-purple-500/10 to-pink-500/10 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Your destination for the latest trends and timeless classics. We
              bring you fashion that speaks to your style.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Founded in 2020, FashionFusion was born from a simple idea:
                    fashion should be accessible, affordable, and exciting for
                    everyone. What started as a small online boutique has grown
                    into a thriving fashion destination serving thousands of
                    customers across India.
                  </p>
                  <p>
                    We believe that great style shouldn't come with a hefty
                    price tag. That's why we work directly with manufacturers
                    and designers to bring you the latest trends at prices that
                    won't break the bank.
                  </p>
                  <p>
                    Today, we're proud to offer a curated collection of
                    clothing, accessories, and footwear for men, women, and
                    kids. Every piece is carefully selected to ensure quality,
                    style, and value.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    beyond to ensure you have an amazing shopping experience.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Every product is carefully inspected to meet our high
              ...
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-muted-foreground">
                    We stay ahead of the curve, bringing you the latest fashion
              ...
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-muted-foreground">
                    We listen to our customers and constantly evolve based on
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                To democratize fashion by making the latest trends accessible to
                everyone, regardless of budget. We believe everyone deserves to
                look and feel their best.
              </p>
              <div className="bg-primary/5 p-8 rounded-2xl">
                <p className="text-xl font-semibold mb-4">
                  "Fashion is not just about clothes. It's about confidence,
                  self-expression, and feeling amazing every day."
                </p>
        ...
        <section className="py-16 bg-gradient-to-r from-primary to-purple-600 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-4">
              Join the FashionFusion Family
            </h2>
            <p className="text-lg mb-8 opacity-90">
              Start your style journey with us today. Discover fashion that fits
              your life.
            </p>
        ...
        <div className="opacity-0 h-0 overflow-hidden" aria-hidden="true">
          Developed by ARCHER | GitHub: @yasuo72 | https://github.com/yasuo72
        </div>
      </main>
